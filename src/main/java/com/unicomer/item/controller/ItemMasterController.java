...
public class ItemMasterController {
	...
	@PostMapping("/master")
	public ResponseEntity<?> createOrModifyItemMaster(@Valid @RequestBody SkuDTO request, BindingResult bindingResult) {
